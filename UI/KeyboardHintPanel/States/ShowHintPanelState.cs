...
public class ShowHintPanelState : StateBaseWithActions<KeyboardHintPanel>
{
    ...
    private enum ActionEnum { AE_FADEIN, AE_WAITONE, AE_MOVETOC, AE_TYPEC, AE_WAITTWO, AE_MOVETOA, AE_TYPEA, AE_WAITTHREE, AE_MOVETOR, AE_TYPET, AE_WAITFOUR, AE_FADEOUT, AE_Length }
        ...
        : base(refPanel)
    {
        ...
        m_actions[(int)ActionEnum.AE_MOVETOR] = new movAtoB(m_refObj.m_finger.gameObject, m_refObj.m_AKey.position, m_refObj.m_RKey.position, 2, 0);
        m_actions[(int)ActionEnum.AE_TYPET] = new TypeText(m_refObj.m_text, "R", 0.01f);
    ...
    public override void initState()
    {
        ...
        ((movAtoB)m_actions[(int)ActionEnum.AE_MOVETOR]).setup(m_refObj.m_finger.gameObject, m_refObj.m_AKey.position, m_refObj.m_RKey.position, 2, 0);
    ...
    {
        resetState();
        m_refObj.gameObject.SetActive(false);
